...
export default  function Future() {
  ...
  // Function to handle the transcript received from SpeechToText component
      ...
      <div className="flex-grow bg-white dark:bg-gray-900 overflow-y-auto">
        <div className="sm:px-7 sm:pt-7 px-4 pt-4 flex flex-col w-full border-b border-gray-200 bg-white dark:bg-gray-900 dark:text-white dark:border-gray-800 sticky top-0">
          ...
          <div className="flex items-center space-x-3 sm:mt-7 mt-4">
            <a href="#" className="px-3 border-b-2 border-blue-500 text-blue-500 dark:text-white dark:border-white pb-1.5">Developments</a>
            
          </div>
        </div>
        <div className="sm:p-7 p-4">
        <h4 className="font-bold text-3xl mb-4">Current and Future Developments</h4>
      
        <div className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
          <li className="font-bold mb-4">Voice Input Feature</li>
          <SpeechToText onTranscript={handleTranscript} transcript={transcript} />
